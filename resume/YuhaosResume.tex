...
{{\raisebox{-0.05\height}{\faMobile} +1 4376675335}} 
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \textbf{Researcher} - Dr. GPT \hfill \textbf{Jan 2026 - Present} \\[4pt]
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
            \item Maintained the \href{https://llm-psych-assessment-demo.onrender.com/}{English} and \href{https://llm-psych-assessment-chinese-demo.onrender.com/}{Chinese} versions of an LLM-powered psychological assessment platform.
            \item Built CI/CD pipelines to automate build and deployment workflows.
            \item Contributed to platform deployment and service delivery in mainland China.
        \end{itemize}
    \end{minipage}
\end{tabularx}

\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \textbf{Researcher} - pyKeyATM project \hfill \textbf{Jan 2025 - Now} \\[4pt]
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \textbf{Researcher} - \href{https://github.com/Feng-Ji-Lab/BKT}{rBKT Project} \hfill \textbf{Aug 2024 - Dec 2025} \\[4pt]
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
    \textbf{Researcher} - \href{https://github.com/Feng-Ji-Lab/fedirt}{Fed IRT} \hfill \textbf{Jan 2024 - Aug 2024} \\[4pt]
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
            \item Co-developed FedIRT, an open-source R package for privacy-preserving estimation of 1PL, 2PL, and graded response models using federated learning.
            \item Implemented and evaluated FedAvg workflows and a Shiny client-server interface, enabling institutions to estimate IRT parameters collaboratively without sharing raw data.
        \end{itemize}
    \end{minipage}
    \end{tabularx}

\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{Reasercher} - Entrepreneurial Project \hfill \textbf{Aug 2021 - Jul 2024} \\[4pt]
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
...
\begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=2pt]
    ...
    \item Zhou, B., \textbf{Yuan, Y.}, Luo, N., Qi, J., \& Ji, F. (2025). FedIRT: An R package and Shiny app for estimating federated item response theory models. \textit{Journal of Open Source Software, 10}(113), 7869. \href{https://doi.org/10.21105/joss.07869}{doi:10.21105/joss.07869}
\end{itemize}
\end{minipage}
